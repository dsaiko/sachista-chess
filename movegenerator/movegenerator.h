...
#define GENERATE_MOVE(PIECE, PROMOTIONPIECE, SOURCEINDEX, TARGETINDEX, ENPASSANT)                                                                            \
    if(*movesIndex < bufferSize) {                                                                                                      \
       moves[*movesIndex] =  (struct move){(PIECE), (PROMOTIONPIECE), (SOURCEINDEX), (TARGETINDEX), (ENPASSANT)};               \
       *movesIndex +=1;                                                                                                                 \
    }
