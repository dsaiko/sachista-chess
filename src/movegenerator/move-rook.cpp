...
bitmask MoveGeneratorRook::generateAttacks(const ChessBoard &board, const Color color) const
{
...
void MoveGeneratorRook::generateMoves(const ChessBoard &board, MoveArray &moves) const
{
